...
namespace KatmanliMimariProject.Web.ApiService
{
    public class CategoryApiService
    {
        ...
        {
            var stringContent = new StringContent(JsonConvert.SerializeObject(categoryDto), encoding: Encoding.UTF8, "application/json");
